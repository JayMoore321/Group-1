...
var image = new Array()
slideimage[0] = new Image()
slideimage[0].src = "4.jpg"
slideimage[1] = new Image()
slideimage[1].src = "6.jpg"
slideimage[2] = new Image()
slideimage[2].src = "3.jpg"
slideimage[3] = new Image()
slideimage[3].src = "5.jpg"
</script>
<script type="text/javascript">
...
function slidelink(){
 if (whichimage == 0)
  window.location = "GameReview.php"
...
<div class="slideshow">
<img src="slideshow1.jpg" id="slide" width="1010" height="360" solid border="20" style= "border-color:green"; />
</div>
<script type="text/javascript">
...
<tr width="200px">
    <td align="center">  <img src ="./gameimages/61.png" width="200px" height="300px"> </td>
...
<tr width="200px">
    <td align="center">  <img src ="./gameimages/78.png" width="200px" height="300px"></td>

  </tr>
  <tr>
    <td align="center"><FORM METHOD="LINK" ACTION="latestoffers.php">
<INPUT TYPE="submit" VALUE="Buy Here">
</FORM></td>		
