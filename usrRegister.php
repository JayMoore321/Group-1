...
$query = "INSERT INTO CUSTOMER  values('".$_POST['regUsername']."','".$_POST['regPassword']."','".$_POST["regEmail"]."','".$_POST['regDelAdd']."','".$_POST['regDelPost']."','".$_POST['regBilAdd']."','".$_POST['regBilPost']. "','')";
